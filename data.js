...
const APP_DATA = {
    ...
    it: {
        ui: {
            ...
            login_prompt: "Inserisci la chiave di cifratura (password) per accedere ai progetti privati – Solo collaboratori",
    ...
    en: {
        ui: {
            ...
            login_prompt: "Enter the encryption key (password) to access private projects – Collaborators only",
